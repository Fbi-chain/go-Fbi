...
// NewInt returns a pointer GoFbi's wrapper Int
...
/*
Block represents a Fbi block.

RPC:
	/chains/<chain_id>/blocks/<block_id> (<dyn>)

Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-contracts-contract-id-balance
*/
type Block struct {
...
/*
Header represents the header in a Fbi block
...
/*
Metadata represents the metadata in a Fbi block
...
/*
TestChainStatus represents the testchainstatus in a Fbi block
...
/*
MaxOperationListLength represents the maxoperationlistlength in a Fbi block
...
/*
Level represents the level in a Fbi block
...
/*
BalanceUpdates represents the balance updates in a Fbi block
...
/*
OperationResult represents the operation result in a Fbi block
...
/*
Operations represents the operations in a Fbi block
...
/*
Contents represents the contents in a Fbi operations
...
/*
ContentsMetadata represents the contents metadata in a Fbi operations
...
/*
InternalOperationResults represents a field in contents metadata in a Fbi operations
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-chains-chain-id-blocks
*/
func (t *GoFbi) Head() (*Block, error) {
...
*/
func (t *GoFbi) Block(id interface{}) (*Block, error) {
...
*/
func (t *GoFbi) OperationHashes(blockhash string) ([][]string, error) {
