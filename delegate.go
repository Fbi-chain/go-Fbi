...
/*
FrozenBalance represents the frozen balance RPC on the Fbi network.

RPC:
	../<block_id>/context/delegates/<pkh>/frozen_balance (GET)

Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-delegates-pkh-frozen-balance
*/
...
/*
Delegate represents the frozen delegate RPC on the Fbi network.

RPC:
	../<block_id>/context/delegates/<pkh> (GET)

Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-delegates-pkh
*/
...
/*
BakingRights represents the baking rights RPC on the Fbi network.

RPC:
	../<block_id>/helpers/baking_rights (GET)

Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-helpers-baking-rights
*/
...
/*
EndorsingRights represents the endorsing rights RPC on the Fbi network.
...
/*
BakingRightsInput is the input for the goFbi.BakingRights function.

Function:
	func (t *GoFbi) BakingRights(input *BakingRightsInput) (*BakingRights, error) {}
*/
...
/*
EndorsingRightsInput is the input for the goFbi.EndorsingRights function.

Function:
	func (t *GoFbi) EndorsingRights(input *EndorsingRightsInput) (*EndorsingRights, error) {}
*/
...
/*
DelegatesInput is the input for the goFbi.Delegates function.

Function:
	func (t *GoFbi) Delegates(blockhash string) ([]string, error) {}
*/
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-delegates-pkh-delegated-contracts
...
*/
func (t *GoFbi) DelegatedContracts(blockhash, delegate string) ([]*string, error) {
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoFbi) DelegatedContractsAtCycle(cycle int, delegate string) ([]*string, error) {
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoFbi) FrozenBalance(cycle int, delegate string) (FrozenBalance, error) {
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoFbi) Delegate(blockhash, delegate string) (Delegate, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-delegates-pkh-staking-balance
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoFbi) StakingBalance(blockhash, delegate string) (*big.Int, error) {
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoFbi) StakingBalanceAtCycle(cycle int, delegate string) (*big.Int, error) {
	snapshot, err := t.Cycle(cycle)
	if err != nil {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-helpers-endorsing-rights
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-delegates
...
Parameters:
	...
	delegate:
		The tz(1-3) address of the delegate.
*/
func (t *GoFbi) Delegates(input DelegatesInput) ([]*string, error) {
	err := validator.New().Struct(input)
	if err != nil {
