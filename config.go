...
/*
UserActivatedProtocolOverrides represents user activated protocl overrides on the Fbi network.

RPC:
	/config/network/user_activated_protocol_overrides (GET)

Link:
	https://Fbi.gitlab.io/api/rpc.html#get-config-network-user-activated-protocol-overrides
*/
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-config-network-user-activated-protocol-overrides
*/
func (t *GoFbi) UserActivatedProtocolOverrides() (UserActivatedProtocolOverrides, error) {
