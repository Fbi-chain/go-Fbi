...
/*
Checkpoint represents a Fbi checkpoint.

RPC:
	/chains/<chain_id>/checkpoint (GET)

Link:
	https://Fbi.gitlab.io/api/rpc.html#get-chains-chain-id-checkpoint
*/
...
/*
InvalidBlock represents Fbi invalid blocks.

RPC:
	/chains/<chain_id>/invalid_blocks (GET)

Link:
	https://Fbi.gitlab.io/api/rpc.html#get-chains-chain-id-invalid-blocks
*/
...
/*
BlocksInput is the input for the goFbi.Blocks function.
...
*/
func (t *GoFbi) Blocks(input BlocksInput) ([][]string, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-chains-chain-id-chain-id
*/
func (t *GoFbi) ChainID() (string, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-chains-chain-id-checkpoint
*/
func (t *GoFbi) Checkpoint() (Checkpoint, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-chains-chain-id-invalid-blocks
*/
func (t *GoFbi) InvalidBlocks() ([]InvalidBlock, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-chains-chain-id-invalid-blocks-block-hash
*/
func (t *GoFbi) InvalidBlock(blockHash string) (InvalidBlock, error) {
...
/*
DeleteInvalidBlock remove an invalid block for the Fbi storage.

Path:
	/chains/<chain_id>/invalid_blocks/<block_hash> (DELETE)

Link:
	https://Fbi.gitlab.io/api/rpc.html#delete-chains-chain-id-invalid-blocks-block-hash
*/
func (t *GoFbi) DeleteInvalidBlock(blockHash string) error {
