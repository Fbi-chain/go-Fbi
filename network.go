...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-network-version
*/
type Version struct {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-constants
*/
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-network-connections
*/
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-monitor-bootstrapped
*/
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-monitor-active-chains
*/
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-network-version
*/
func (t *GoFbi) Version() (Version, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-constants
*/
func (t *GoFbi) Constants(blockhash string) (Constants, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-network-connections
*/
func (t *GoFbi) Connections() (Connections, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-monitor-bootstrapped
*/
func (t *GoFbi) Bootstrap() (Bootstrap, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-monitor-commit-hash
*/
func (t *GoFbi) Commit() (string, error) {
...
/*
Cycle gets information about a Fbi snapshot or cycle.

Path:
	../context/raw/json/cycle/%d" (GET)

Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-raw-bytes
*/
func (t *GoFbi) Cycle(cycle int) (Cycle, error) {
	head, err := t.Head()
	if err != nil {
...
func (t *GoFbi) getCycleAtHash(blockhash string, cycle int) (Cycle, error) {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-monitor-active-chains
*/
func (t *GoFbi) ActiveChains() (ActiveChains, error) {
