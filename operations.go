...
/*
InjectionOperationInput is the input for the goFbi.InjectionOperation function.

Function:
	func (t *GoFbi) InjectionOperation(input InjectionOperationInput) ([]byte, error) {}
*/
...
/*
InjectionBlockInput is the input for the goFbi.InjectionBlock function.

Function:
	func (t *GoFbi) InjectionBlock(input InjectionBlockInput) ([]byte, error) {}
*/
...
/*
UnforgeOperationWithRPCInput is the input for the goFbi.UnforgeOperationWithRPC function.

Function:
	func (t *GoFbi) UnforgeOperationWithRPC(blockhash string, operation string, checkSignature bool) (Operations, error) {}
*/
...
/*
ForgeOperationWithRPCInput is the input for the goFbi.ForgeOperationWithRPC function.
...
Fields:
	...
	CheckRPCAddr:
		Overides the GoFbi client with a new one pointing to a different address. This allows the user to validate the forge against different nodes for security.

Function:
	func (t *GoFbi) ForgeOperationWithRPC(blockhash, branch string, contents ...Contents) (string, error) {}
*/
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#post-block-id-helpers-preapply-operations
...
*/
func (t *GoFbi) PreapplyOperations(input PreapplyOperationsInput) ([]Operations, error) {
...
Link:
	https/Fbi.gitlab.io/api/rpc.html#post-injection-operation
...
*/
func (t *GoFbi) InjectionOperation(input InjectionOperationInput) (string, error) {
	err := validator.New().Struct(input)
	if err != nil {
...
/*
ForgeOperationWithRPC will forge an operation with the Fbi RPC. For
...
If you would rather not use a node at all, GoFbi supports local forging
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#post-block-id-helpers-forge-operations
...
Parameters:
	...
	contents:
		The contents of the of the operation.
*/
func (t *GoFbi) ForgeOperationWithRPC(input ForgeOperationWithRPCInput) (string, error) {
	err := validator.New().Struct(input)
	if err != nil {
		return "", errors.Wrap(err, "invalid input")
	}
...
/*
UnforgeOperationWithRPC will unforge an operation with the Fbi RPC.

If you would rather not use a node at all, GoFbi supports local unforging
operations REVEAL, TRANSFER, ORIGINATION, and DELEGATION.
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#post-block-id-helpers-parse-operations
...
*/
func (t *GoFbi) UnforgeOperationWithRPC(blockhash string, input UnforgeOperationWithRPCInput) ([]Operations, error) {
	err := validator.New().Struct(input)
	if err != nil {
...
Link:
	https://Fbi.gitlab.io/api/rpc.html#get-block-id-context-contracts-contract-id-counter
...
*/
func (t *GoFbi) Counter(blockhash, pkh string) (int, error) {
...
/*
ForgeOperation forges an operation locally. GoFbi does not use the RPC or a trusted source to forge operations.
...
/*
ForgeTransactionOperation forges a transaction operation(s) locally. GoFbi does not use the RPC or a trusted source to forge operations.
Current supported operations include transfer, reveal, delegation, and origination.
...
/*
ForgeRevealOperation forges a reveal operation(s) locally. GoFbi does not use the RPC or a trusted source to forge operations.
Current supported operations include transfer, reveal, delegation, and origination.
...
/*
ForgeOriginationOperation forges a origination operation(s) locally. GoFbi does not use the RPC or a trusted source to forge operations.
Current supported operations include transfer, reveal, delegation, and origination.
...
/*
ForgeDelegationOperation forges a delegation operation(s) locally. GoFbi does not use the RPC or a trusted source to forge operations.
Current supported operations include transfer, reveal, delegation, and origination.
...
/*
UnforgeOperation takes a forged/encoded Fbi operation and decodes it by returning the
